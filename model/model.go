...
type Service struct {
	...
	InViews         []string `json:"in_views,omitempty"`     // A list of views this service is included in
}
...
type View struct {
	...
	LastStateChange int64    `json:"last_state_change"` // Time when the view last changed state
}
